...
export const EMAIL_SETTINGS =
  process.env.NODE_ENV === "test"
    ? {}
    : JSON.parse(process.env.EMAIL_SETTINGS || "{}");
export const EMAIL = {
...
export const COINMARKETCAP_BASE_URL =
  "https://pro-api.coinmarketcap.com/v1/cryptocurrency/";
export const CRYPTO_IMAGE_BASE_URL =
  "https://assets.kraken.com/marketing/web/icons/";
export const COINMARKETCAP_API_KEY =
  process.env.COINMARKETCAP_API_KEY || "53e03511-90dc-41eb-8521-e30e6a353f7c";
